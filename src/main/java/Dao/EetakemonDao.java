...
public class EetakemonDao implements IEetakemonDao {
    ...
    return true;}
    public boolean updateEetakemonToUserId(Hashtable<String, Integer> conditions){return  true;}
    public boolean removeEetakemonToUserById(int i){return true;}
    ...
    public EetakemonsUser getEetakemonToUserById(int i){return null;}
