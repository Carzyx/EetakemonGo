...
public class AtackDao implements IAtackDao{
    ...
    //Actions for Atacks
    public boolean addAtack(Atack atack){return _service.add(atack);}
    public boolean updateAtack(Atack atack){return _service.updateById(atack);}
    public boolean removeAtackById(Atack atack){return _service.removeById(atack);}
    public List<Atack> getAll(){return null;}
    ...
    public boolean updateAtackToEetakemon(int i, int j){return true;}
    public boolean removeAtackToEetakemonById(int i){return true;}
    ...
    public AtacksEetakemon getAtackToEetakekonById(int i){return null;}
